  ...
  public static async getHttpElements(
    ...
    originalElements.push(
      new HttpElement(
        ...
        new SnippetString(
          `{{$\${name:${Constants.GuidVariableName.slice(1)}}}}`
        )
      )
    );
    originalElements.push(
      new HttpElement(
        ...
        new SnippetString(
          `{{$\${name:${Constants.TimeStampVariableName.slice(1)}}}}`
        )
      )
    );
    originalElements.push(
      new HttpElement(
        ...
        new SnippetString(
          `{{$\${name:${Constants.DateTimeVariableName.slice(
            1
          )}} \${1|rfc1123,iso8601|}}}`
        )
      )
    ...
    originalElements.push(
      new HttpElement(
        ...
        new SnippetString(
          `{{$\${name:${Constants.LocalDateTimeVariableName.slice(
            1
          )}} \${1|rfc1123,iso8601|}}}`
        )
      )
    ...
    originalElements.push(
      new HttpElement(
        ...
        new SnippetString(
          `{{$\${name:${Constants.RandomIntVariableName.slice(
            1
          )}} \${1:min} \${2:max}}}`
        )
      )
    ...
    originalElements.push(
      new HttpElement(
        ...
        new SnippetString(
          `{{$\${name:${Constants.ProcessEnvVariableName.slice(
            1
          )}} \${2:process environment variable name}}}`
        )
      )
    );
    originalElements.push(
      new HttpElement(
        ...
        new SnippetString(
          `{{$\${name:${Constants.DotenvVariableName.slice(
            1
          )}} \${2:.env variable name}}}`
        )
      )
    ...
    originalElements.push(
      new HttpElement(
        Constants.OAuth2VariableName,
        ElementType.SystemVariable,
        null,
        Constants.OAuth2Description,
        new SnippetString(
          `{{$\${name:${Constants.OAuth2VariableName.slice(
            1
          )}} \${2:provider}}}`
        )
      )
    ...
    originalElements.push(
      new HttpElement(
        ...
        new SnippetString(
          `{{$\${name:${Constants.AzureActiveDirectoryVariableName.slice(1)}}}}`
        )
      )
    );
    ...
    const requestVariables = await RequestVariableProvider.Instance.getAll(
      document
    );
    ...
    const distinctRequestUrls = Array.from(
      new Set(historyItems.map(item => item.url))
    );
    distinctRequestUrls.forEach(requestUrl => {
      ...
      originalElements.push(
        new HttpElement(
          ...
          ElementType.URL,
          "^\\s*(?:(?:GET|POST|PUT|DELETE|PATCH|HEAD|OPTIONS|CONNECT|TRACE)\\s+)https?\\:\\/{2}"
        )
      );
    });
